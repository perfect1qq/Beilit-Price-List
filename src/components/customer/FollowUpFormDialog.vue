<template>
  <FormDialog ref="followUpDialogRef" :model-value="visible" @update:model-value="$emit('update:modelValue', $event)"
    title="添加跟进记录" :width="500" :form-data="localData" :rules="formRules" label-width="100px" :append-to-body="true"
    @submit="$emit('submit', $event)">
    <el-form-item label="跟进内容" prop="content">
      <el-input v-model="localData.content" type="textarea" :rows="4" placeholder="请输入跟进内容" maxlength="1000"
        show-word-limit />
    </el-form-item>
    <el-form-item label="下次跟进" prop="nextTime">
      <el-date-picker v-model="localData.nextTime" type="date" placeholder="选择下次跟进时间" format="YYYY-MM-DD"
