<template>
  <FormDialog ref="formDialogRef" :model-value="visible" @update:model-value="$emit('update:modelValue', $event)"
    :title="title" :width="500" :form-data="formData" :rules="formRules" label-width="100px"
    @submit="$emit('submit', $event)">
    <el-form-item label="公司名称" prop="companyName">
      <el-input v-model="localFormData.companyName" placeholder="请输入公司名称" maxlength="100" show-word-limit />
    </el-form-item>
    <el-form-item label="客户姓名" prop="customerName">
      <el-input v-model="localFormData.customerName" placeholder="请输入客户姓名" maxlength="50" show-word-limit />
    </el-form-item>
    <el-form-item label="联系方式" prop="contactInfo">
      <el-input v-model="localFormData.contactInfo" placeholder="请输入联系方式（电话、微信等）" maxlength="100" show-word-limit />
    </el-form-item>
    <el-form-item label="合作状态" prop="cooperationStatus">
      <el-select v-model="localFormData.cooperationStatus" placeholder="选择合作状态" style="width: 100%">
        <el-option label="未合作" value="未合作" />
        <el-option label="已合作" value="已合作" />
      </el-select>
    </el-form-item>
    <el-form-item label="客户类型" prop="customerType">
      <el-select v-model="localFormData.customerType" placeholder="选择客户类型" style="width: 100%">
    ...
    <el-form-item label="工期" prop="deliveryDays">
      <div class="delivery-input-row">
        <el-input-number v-model="localFormData.deliveryDays" :min="1" :max="365" controls-position="right"
          placeholder="天数" style="width: 140px" />
        <span class="delivery-unit">天</span>
        <span v-if="localFormData.deliveryDays && localFormData.deliveryDays > 0" class="delivery-preview">
          → 预计完成：{{ getDeliveryDate(localFormData.deliveryDays) }}
        </span>
      </div>
    </el-form-item>
    <el-form-item label="备注" prop="remark">
      <el-input v-model="localFormData.remark" type="textarea" :rows="3" placeholder="请输入备注信息（可选）" maxlength="500"
        show-word-limit />
    </el-form-item>
  </FormDialog>
</template>
